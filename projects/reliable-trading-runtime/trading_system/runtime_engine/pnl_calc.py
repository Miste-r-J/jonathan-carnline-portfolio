...
try:  # pragma: no cover - best effort import
    from trading_system.runtime_engine.modeling.config import instrument_by_alias as _instrument_lookup  # type: ignore
    from trading_system.runtime_engine.modeling.config import INSTRUMENTS as _INSTRUMENTS  # type: ignore
...
def load_trades_dataframe(
    ...
    `entry_time/exit_time` CSVs produced by live_trading_runtime/preset_eval.
    """
...
def compute_pnl_stats_from_trades(
    ...
    """
    Standalone stats summary used by the bot orchestration layer.
    """
    if trade_df.empty:
        return {
            "total_pnl": 0.0,
