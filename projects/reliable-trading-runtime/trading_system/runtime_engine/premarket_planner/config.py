...
from ..integrations.route_config import default_openclaw_config_path, load_openclaw_routes
...
DATA_DEFAULT_PATH = Path("/etc/trading-runtime/premarket_planner.yaml")
...
def load_config(path: Optional[str] = None) -> PlannerConfig:
    ...
    Resolution order:
      ...
      3. `/etc/trading-runtime/premarket_planner.yaml`.
