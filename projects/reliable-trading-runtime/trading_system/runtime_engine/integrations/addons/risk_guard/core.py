...
logger = logging.getLogger("trading_runtime.risk_guard")
...
class RiskGuard:
    """
    Standalone RiskGuard that enforces basic daily limits from the YAML config.
    ...
    def last_policy_snapshot(self, instrument: str) -> Dict[str, Any]:
        ...
        snapshot.setdefault("cfg_sha256", "trading_system")
        return snapshot
