...
DEFAULT_DENY_MODULES = {
    "trading_system.runtime_engine.integrations.nt_bridge",
    "trading_system.runtime_engine.integrations.nt_execution",
    "trading_system.runtime_engine.integrations.mjt_bridge",
    "trading_system.runtime_engine.integrations.mock_nt_transport",
    "trading_system.runtime_engine.modeling.online_learning",
}
