"""Adapter bridging live_trading_runtime with the RiskGuard addon."""
...
from trading_system.runtime_engine.integrations.addons.risk_guard import Context, PolicyDecision, RiskGuard
