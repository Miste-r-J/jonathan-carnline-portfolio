...
from trading_system.runtime_engine.modeling.EnhancedGuardrails import EnhancedGuardRailConfig, EnhancedGuardrails
from trading_system.runtime_engine.modeling.PropRiskManager import PropRiskConfig
from trading_system.runtime_engine.modeling.VolatilityFilter import VolatilityConfig
from trading_system.runtime_engine.integrations.addons.risk_guard import Context, RiskGuard
...
def test_load_prop_guardrails_returns_initialized_bundle():
    config_path = Path(__file__).resolve().parents[1] / "runtime_config" / "prop_config.yaml"
