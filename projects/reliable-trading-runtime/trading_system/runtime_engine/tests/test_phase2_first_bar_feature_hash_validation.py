...
def test_feature_hash_validator_raises_on_first_mismatch() -> None:
    from trading_system.runtime_engine.modeling.exceptions import FeatureMismatchError
    from trading_system.runtime_engine.modeling.feature_hash import FeatureHashOnceValidator, compute_feature_hash
