...
try:
    ...
    raise RuntimeError(
        "The trading runtime package is not importable. Install the repo (`python -m pip install -e .`) "
        "and run this trainer via `python -m trading_system.runtime_engine.modeling.train_hgb_multi`."
    ) from exc

from ..shared.label_schema import LabelSchema
