...
try:  # pragma: no cover - dual import for script vs package usage
    ...
    from trading_system.runtime_engine.shared.proba import ensure_long_index, select_long_proba  # type: ignore
...
from trading_system.runtime_engine.l3.bot.risk_engine import RiskConfig
