...
## Parity
- `python trading_system/development_tools/check_deployable_phase2_candidate.py --tag retrain_v6_fixed_v2_hyper_016_livebundle_v1`
- `python trading_system/development_tools/phase2_rebuild_parity_audit.py --preset es_elite_v1_live_ready --resolved-config <resolved_config.json>`
