"""
Minimal online-learning shim for the simplified gym.
...
from na.common.experience import Experience
...
class OnlineLearningConfig:
    ...
    but the simplified version keeps the semantics intentionally loose.
    """
...
def default_online_config(symbol: str = "ES") -> OnlineLearningConfig:
    # Symbol hook left in place for compatibility; not used in the simplified build.
