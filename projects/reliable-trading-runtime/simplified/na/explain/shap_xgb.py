...
from na.bot.models import load_model, model_features
...
LOGGER = logging.getLogger("na.explain.shap")
...
def load_xgb_model(path: str | Path) -> Any:
    """
    Convenience wrapper around na.bot.models.load_model with clear logging.
    """
