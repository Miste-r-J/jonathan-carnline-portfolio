...
from tools.phase2_rebuild_parity_audit import audit_phase2_rebuild_parity
...
def test_phase2_rebuild_parity_no_retrain_needed(tmp_path: Path) -> None:
    ...
    master_config = repo_root / "na" / "config" / "master.yaml"
    _write_text(master_config, _master_yaml("retrain_v6_fixed_v2_hyper_016", str(close_model)))

    runtime_file = repo_root / "na" / "discord_addons" / "cli" / "stream_live_csv.py"
