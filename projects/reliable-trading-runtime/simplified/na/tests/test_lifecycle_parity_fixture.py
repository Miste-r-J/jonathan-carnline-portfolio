...
# Add the simplified root to path
_SIMPLIFIED_ROOT = Path(__file__).resolve().parents[3]
if str(_SIMPLIFIED_ROOT) not in sys.path:
    sys.path.insert(0, str(_SIMPLIFIED_ROOT))
