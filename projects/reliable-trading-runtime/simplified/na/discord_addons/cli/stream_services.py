...
Phase 4 wiring: stream_live_csv.py imports these services and delegates to them
...
class SubprocessRunner:
    ...
    Every subprocess call in stream_live_csv.py should route through this
...
class FeatureGuard:
    ...
    def __init__(self) -> None:
        try:
            from na.bot.exceptions import FeatureMismatchError as _FME
            from na.bot.feature_constants import MANDATORY_MODEL_FEATURES as _MMF
            from na.bot.feature_hash import validate_feature_schema_and_hash as _VFSH
...
class RiskConfigLoader:
    ...
    Centralises the three _load_*_risk_* functions from stream_live_csv.py
