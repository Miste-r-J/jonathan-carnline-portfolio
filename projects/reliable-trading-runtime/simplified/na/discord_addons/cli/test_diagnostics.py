...
Run with:
    python -m pytest simplified/na/discord_addons/cli/test_diagnostics.py -v

Integration test (requires tuesday326pt2 run data):
    python -m pytest simplified/na/discord_addons/cli/test_diagnostics.py -v -m integration
"""
