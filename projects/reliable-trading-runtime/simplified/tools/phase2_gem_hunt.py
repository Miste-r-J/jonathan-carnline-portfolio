...
def _report_markdown(
    ...
    lines.append(f"- Active `phase2_tag` (`na/config/master.yaml`): `{runtime_ctx.active_phase2_tag}`")
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--master-yaml", default=str(ROOT / "na" / "config" / "master.yaml"))
